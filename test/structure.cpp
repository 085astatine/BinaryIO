...
BOOST_AUTO_TEST_CASE(bit_offset_and_index) {
  using TestStructure = Structure<
          TestKey,
          Element<TestKey, TestKey::Key00, 1, uint8_t>,
          Element<TestKey, TestKey::Key01, 3, uint8_t>,
          Element<TestKey, TestKey::Key02, 4, uint8_t>>;
  // offset
  BOOST_CHECK_EQUAL(TestStructure::bit_offset<TestKey::Key00>(), 0);
  BOOST_CHECK_EQUAL(TestStructure::bit_offset<TestKey::Key01>(), 1);
  BOOST_CHECK_EQUAL(TestStructure::bit_offset<TestKey::Key02>(), 4);
  ...
  BOOST_CHECK_EQUAL(TestStructure::element_index<TestKey::Key02>(), 2);
